...
func! PhpDocFunc()
	...
	while (l:parameters != ",") && (l:parameters != "")
		...
		exe l:txtBOL . g:pdv_cfg_Commentn . "@param" . l:paramtype . " $" . l:paramname . " The " . l:paramname . "." . g:pdv_cfg_EOL
	endwhile
...
func! PhpDocVar()
    ...
    exe l:txtBOL . g:pdv_cfg_Commentn . "@var " . l:type . " " . l:varname . " The " . l:varname . "." . g:pdv_cfg_EOL
    "if l:scope != ""
    "    exe l:txtBOL . g:pdv_cfg_Commentn . "@access " . l:scope . g:pdv_cfg_EOL
    "endif
